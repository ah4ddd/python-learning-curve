...
my_new_car = car.Ferrari("Ferrari","sp3", 2021, "red")
...
my_used_car = car.Subaru('subaru', 'outback', 2015)
...
print(f"Owner : {car.Car.owner}")
print(f"{car.Car.owner} owns {car.Car.cars} cars, {my_new_car.get_descriptive_name()}, {my_used_car.get_descriptive_name()} & {my_tesla.get_descriptive_name()}")
